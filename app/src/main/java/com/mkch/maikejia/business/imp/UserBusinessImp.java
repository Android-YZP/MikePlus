package com.mkch.maikejia.business.imp;
...
import com.mkch.maikejia.util.ConvertUtil;
...
//		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_md5value is ", _md5_value.substring(0,8));
	...
	public String getMobilemsgRegister(String phone) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getMobilemsgRegister", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getMobilemsgValidate(String phone, String smsCode)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getMobilemsgValidate", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserRegister(String mPhone, String mCode, String username,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserRegister", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserLogin(String pPhone, String pPassword)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserLogin", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserForgotPasswordOne(String phone) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserForgotPasswordOne", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserForgotPasswordTwo(String mPhone, String smsCode,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserForgotPasswordTwo", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserDetail(int userid) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserDetail", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
	...
	public String getUserAttentionUserList(int pageNo, int pageSize, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserAttentionUserList", _json_args.toString());
	...
	public String deleteUserAttentionUser(int friendId, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_deleteUserAttentionUser", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserFansList(int pageNo, int pageSize, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserFansList", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String deleteUserFans(int friendId, User mUser) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_deleteUserFans", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserCommentsList(int pageNo, int pageSize, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserCommentsList", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String deleteUserComment(int commentId, User mUser) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_deleteUserComment", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserSelfCommentsList(int pageNo, int pageSize, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserSelfCommentsList", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserMessagesList(int pageNo, int pageSize, User mUser,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserMessagesList", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String deleteUserMessage(int messageId, User mUser) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_deleteUserMessage", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserNoticeDetail(int mNoticeId, User mUser) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserNoticeDetail", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String userCommitCreative(String mTitle, String mIntro,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_userCommitCreative", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String updateUserPwd(String oldpwd, String newpwd, String againpwd,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_updateUserPwd", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserSettingSecurityCode(String phone,User mUser) throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserSettingSecurityCode", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserSettingSecurityPhoneUpdate(String mPhone,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserSettingSecurityPhoneUpdate", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserSettingSecurityEmailCode(String pEmail, User mUser)
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserSettingSecurityEmailCode", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String getUserSettingSecurityEmailUpdate(String mEmail,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_getUserSettingSecurityEmailUpdate", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String updateUserSettingPsInfo(String _usersign,
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_updateUserSettingPsInfo", _json_args.toString());
		//头信息-verifyCode保存在用户信息中
	...
	public String checkAppUpdate() throws Exception {
		...
		_json_args.put("clientVersion", "1.0");
		_json_args.put("clientType", "Phone");
		Log.d(CommonConstants.LOGCAT_TAG_NAME + "_json_checkAppUpdate", _json_args.toString());
		//添加头信息
		String _md5_value = ConvertUtil.getMD5("MAIKEJIA");
